...
class CenterModel {
  ...
  factory CenterModel.fromMap(Map<String, dynamic> json) => CenterModel(
        centers: json["centers"] == null
            ? null
            : List<CenterBlockModel>.from(
                json["centers"].map((x) => CenterBlockModel.fromMap(x))),
      );
...
class CenterBlockModel {
  ...
  factory CenterBlockModel.fromJson(String str) =>
      CenterBlockModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory CenterBlockModel.fromMap(Map<String, dynamic> json) =>
      CenterBlockModel(
        ...
        vaccineFees: json["vaccine_fees"] == null
            ...
            : List<VaccineFee>.from(
                json["vaccine_fees"].map((x) => VaccineFee.fromMap(x))),
  ...
  Map<String, dynamic> toMap() => {
        ...
        "vaccine_fees": vaccineFees == null
            ? null
            : List<dynamic>.from(vaccineFees.map((x) => x.toMap())),
...
class VaccineFee {
  ...
  factory VaccineFee.fromJson(String str) =>
      VaccineFee.fromMap(json.decode(str));
